...
| Rules reference | Inventory v1; simplified calculator records plus one synthetic interaction fixture | Confirmed metadata/synthetic arithmetic only; no native or host-parity evidence |
